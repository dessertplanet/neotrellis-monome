...
function ls() print(fs_list_files()) end
...
midi_note_on = function(note, vel, ch)
	midi_tx((ch or 1)-1 + 0x90, note or 66, vel or 100) end
midi_note_off = function(note, vel, ch)
	midi_tx((ch or 1)-1 + 0x80, note or 66, vel or 100) end
midi_cc = function(cc, val, ch)
	midi_tx((ch or 1)-1 + 0xb0, cc or 1, val or 100) end
